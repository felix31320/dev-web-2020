<?php
    include 'nav1.php';
               ...
               while($reponse = $detali->fetch()){
                    ?>
                        <div style="display: flex;flex-direction:row;">
                            ...
                            <a href="ps4.php"><button class="retour" value="ok">Retour à la liste des jeux</button></a>
                        </div>
            ...
            $sqlcount="select count(*) as pagetik from ps4";
            ...
            $sql="select * from ps4 where marque='ps4' limit $offset,$per_page";
                ...
                <div id="flex123">
                    <div class="pagegame">
                        ...
                        <img src="<?php echo "../upload/".$reponse['image']; ?>"  class="pagegameimage">
                         <a href="ps4.php?marque=<?php echo $reponse['id']; ?>"><button class="cherchebutton" name="click">Detailes</button></a>
