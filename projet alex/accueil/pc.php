<?php
    include 'nav1.php';
            ...
            if(isset($_GET['marque'])){
                ...
                <?php
                $id = $_GET['marque'];
                $detali = $bdd->query("SELECT * FROM pc WHERE id='$id'");
               while($reponse = $detali->fetch()){
                    ?>
                        <div style="display: flex;flex-direction:row;">
                            ...
                            <a href="pc.php"><button class="retour" value="ok">Retour à la liste des jeux</button></a>
                        </div>
            ...
            $sqlcount="select count(*) as pagetik from pc";
            ...
            $sql="select * from pc where marque='pc' limit $offset,$per_page";
                ...
                <div id="flex123">
                    <div class="pagegame">
                        ...
                        <img src="<?php echo "../upload/".$reponse['image']; ?>"  class="pagegameimage">
                         <a href="pc.php?marque=<?php echo $reponse['id']; ?>"><button class="cherchebutton" name="click">Detailes</button></a>
