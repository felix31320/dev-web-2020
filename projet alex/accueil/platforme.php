<?php
    include 'nav1.php';
            ...
            if(isset($_GET['marque'])){
                ...
                <?php
                $id = $_GET['marque'];
                $detali = $bdd->query("SELECT * FROM jeux WHERE id='$id'");
                while($reponse = $detali->fetch()){
                    ?>
                        <div style="display: flex;flex-direction:row;">

                            <img src="<?php echo "../upload/".$reponse['image']; ?>" style="padding-left: 100px;padding-top:30px;" height="300" width="300">
                            ...
                            <a href="platforme.php"><button class="retour" value="ok">Retour à la liste des jeux</button></a>
                        </div>
            ...
            $sqlcount="select count(*) as pagetik from jeux";
            ...
            $sql="select * from jeux limit $offset,$per_page";
                ...
                <div id="flex123">
                    <div class="pagegame">
                        ...
                        <img src="<?php echo "../upload/".$reponse['image']; ?>"  class="pagegameimage">
                         <a href="platforme.php?marque=<?php echo $reponse['id']; ?>"><button class="cherchebutton" name="click">Detailes</button></a>
